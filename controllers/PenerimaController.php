...
class PenerbitController extends ActiveController
{
    ...
    public function actionAuthenticate(){
        ...
        $client = new Client(['baseUrl' => 'http://35.184.131.200/rest-server/web/index.php?r=site%2Flogin']);
        $response = $client->createRequest()
        ->setMethod('POST')
        ->setUrl('login')
      ...
      public function actionIndex(){
        $client = new Client(['baseUrl' => 'http://35.184.131.200/rest-server/web/index.php?r=v1/penerima']);
        $response = $client->createRequest()
        ->setMethod('GET')
        ->setUrl('index')
        ->addHeaders([
